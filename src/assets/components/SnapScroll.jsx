        ...
        <div className="flex w-full mt-60">
            ...
            <div className="w-1/2 h-screen sticky top-0 bg-[#3c50e6] text-white p-8 flex flex-col text-left justify-left md:justify-center lg:pl-60">
                ...
                <div className="relative">
                    <div className="absolute left-6 top-0 w-0.5 h-full bg-gray-200 transition-all duration-500"></div>
                                ...
                                <div 
                                    className={`w-12 h-12 rounded-full flex items-center justify-center z-10 
                                        ${visibleSection >= num - 1 
                                            ? 'bg-green-500 text-white transition-all duration-500 ease-in-out' 
                                            : 'bg-gray-100 text-gray-700'}`}
                                    style={{ transition: "background-color 0.5s ease, transform 0.5s ease" }}
                                >
                                    {num}
                                </div>
                                <div className="ml-4">
